...
export const config = {
  ...
  openaiWebSearchEnabled: parseBool(process.env.OPENAI_WEB_SEARCH_ENABLED, true),
  openaiWebSearchToolType: String(process.env.OPENAI_WEB_SEARCH_TOOL_TYPE || "web_search").trim() || "web_search",
  openaiWebSearchContextSize: String(process.env.OPENAI_WEB_SEARCH_CONTEXT_SIZE || "medium").trim().toLowerCase() || "medium",
  openaiWebSearchExternalAccess: parseBool(process.env.OPENAI_WEB_SEARCH_EXTERNAL_ACCESS, true),
  openaiWebSearchUserCountry: String(process.env.OPENAI_WEB_SEARCH_USER_COUNTRY || "US").trim(),
  openaiWebSearchUserCity: String(process.env.OPENAI_WEB_SEARCH_USER_CITY || "").trim(),
  openaiWebSearchUserRegion: String(process.env.OPENAI_WEB_SEARCH_USER_REGION || "").trim(),
  openaiWebSearchUserTimezone: String(process.env.OPENAI_WEB_SEARCH_USER_TIMEZONE || "").trim(),
