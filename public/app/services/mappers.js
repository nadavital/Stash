...
export function createMockSeedNotes() {
  ...
  return [
    ...
    {
      id: "mock-core-contract",
      content: "Keep capture, search, and chat behavior aligned through one shared memory contract.",
      summary: "Core app surfaces should share one memory contract.",
      tags: ["core", "contract", "platform"],
      project: "platform",
      sourceType: "text",
      sourceUrl: "",
      imagePath: "",
