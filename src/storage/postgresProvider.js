...
import { createPostgresEnrichmentJobRepo } from "../postgres/enrichmentJobRepo.js";
import { createPostgresCollaborationRepo } from "../postgres/collaborationRepo.js";
...
export function createPostgresProvider({ databaseUrl = "" } = {}) {
  ...
  return {
    ...
    enrichmentJobRepo: createPostgresEnrichmentJobRepo(pool),
    collaborationRepo: createPostgresCollaborationRepo(pool),
